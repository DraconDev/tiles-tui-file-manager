...
pub struct SystemState {
    ...
    pub core_history: Vec<std::collections::VecDeque<u64>>,
    pub mem_history: std::collections::VecDeque<u64>,
    pub swap_history: std::collections::VecDeque<u64>,
    pub net_in: u64,
    pub net_out: u64,
    pub net_in_history: std::collections::VecDeque<u64>,
    pub net_out_history: std::collections::VecDeque<u64>,
    pub last_net_in: u64,
